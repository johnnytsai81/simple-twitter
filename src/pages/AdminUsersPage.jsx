    ...
    return(
      <Container>
        ...
        <UsersItem>
          {/* 個人背景圖/大頭照欄位 */}
          <ImageContainer>
          <img src={background} alt="Background" style={{width:'249px', height:'140px'}}/>
          
          <img src={avatar} alt="Avatar" style={{width:'100px', height:'100px',position: 'absolute', top:'50%'}}/>
          </ImageContainer>
          ...
          <label style={{color:'#171725',margin:'0 0 0 10px'}}>59位</label>跟隨者
          </TextContainer>
        </UsersItem>
